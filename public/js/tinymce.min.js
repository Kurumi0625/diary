...
!function (j) {
  ...
  var ce,
    ...
    return e.prototype.bind = function (e, t, n, r) {
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
        ...
        for (a = m.length; a--;) {
          l = h, s = c = !1, "DOMContentLoaded" === (u = m[a]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, Fe({
            type: u
          })) : (f.hasMouseEnterLeave || (s = f.mouseEnterLeave[u]) && (l = function l(e) {
            var t, n;
          ...
          }), f.hasFocusIn || "focusin" !== u && "focusout" !== u || (c = !0, s = "focusin" === u ? "focus" : "blur", l = function l(e) {
      ...
      if (r = e[this.expando]) {
        if (s = this.events[r], t) {
          ...
          for (u in s) {
            o = s[u], Ie(e, o.fakeName || u, o.nativeHandler, o.capture);
          }
    ...
    if (Ee && !r) {
      ...
      if (de.qsa && (!Se || !Se.test(e))) {
        if (f = c = qe, d = t, h = 9 === u && e, 1 === u && "object" !== t.nodeName.toLowerCase()) {
          for (l = pe(e), (c = t.getAttribute("id")) ? f = c.replace(xt, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", s = l.length; s--;) {
            l[s] = f + Bt(l[s]);
          }
  ...
  for (fe in de = Et.support = {}, ge = Et.isXML = function (e) {
    ...
    return s !== ze && 9 === s.nodeType && s.documentElement ? (Ne = (ze = s).documentElement, Ee = !ge(s), n && n !== function r(e) {
      ...
      if (_typeof(t.getElementById) !== Qe && Ee) {
    ...
    filter: {
      ...
      CHILD: function CHILD(h, e, t, m, g) {
        ...
        return 1 === m && 0 === g ? function (e) {
          ...
          if (c) {
            ...
            } else if (d && (r = (e[qe] || (e[qe] = {}))[h]) && r[0] === We) a = r[1];else for (; (i = ++u && i && i[l] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[qe] || (i[qe] = {}))[h] = [We, a]), i !== e));) {
              ;
            }
      ...
      PSEUDO: function PSEUDO(e, i) {
        var t,
            a = he.pseudos[e] || he.setFilters[e.toLowerCase()] || Et.error("unsupported pseudo: " + e);
    ...
    pseudos: {
      ...
      contains: kt(function (t) {
        return t = t.replace(zt, Nt), function (e) {
          return -1 < (e.textContent || e.innerText || me(e)).indexOf(t);
        };
      }),
      lang: kt(function (n) {
        return gt.test(n || "") || Et.error("unsupported lang: " + n), n = n.replace(zt, Nt).toLowerCase(), function (e) {
          var t;
  ...
  function Pt(m, g, p, v, y, e) {
    return v && !v[qe] && (v = Pt(v)), y && !y[qe] && (y = Pt(y, e)), kt(function (e, t, n, r) {
      ...
      if (p && p(f, d, n, r), v) for (o = Lt(d, s), v(o, [], n, r), i = o.length; i--;) {
        (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
      }
      ...
      if (e) {
        if (y || m) {
          ...
          for (i = d.length; i--;) {
            (a = d[i]) && -1 < (o = y ? it.call(e, a) : u[i]) && (e[o] = !(t[o] = a));
          }
        }
  ...
  function Vt(e) {
    for (var r, t, n, o = e.length, i = he.relative[e[0].type], a = i || he.relative[" "], u = i ? 1 : 0, s = Ot(function (e) {
      ...
      if (t = he.relative[e[u].type]) c = [Ot(Ht(c), t)];else {
  ...
  _t.prototype = he.filters = he.pseudos, he.setFilters = new _t(), pe = Et.tokenize = function (e, t) {
    ...
    for (a = e, u = [], s = he.preFilter; a;) {
      for (i in n && !(r = ft.exec(a)) || (r && (a = a.slice(r[0].length) || a), u.push(o = [])), n = !1, (r = dt.exec(a)) && (n = r.shift(), o.push({
        value: n,
        type: r[0].replace(ct, " ")
      }), a = a.slice(n.length)), he.filter) {
        he.filter.hasOwnProperty(i) && (!(r = pt[i].exec(a)) || s[i] && !(r = s[i](r)) || (n = r.shift(), o.push({
          value: n,
          type: i,
          matches: r
        }), a = a.slice(n.length)));
      ...
      (i = Ge(e, function a(p, v) {
        var y = 0 < v.length,
          ...
          if (s += l, y && l !== s) {
            ...
            if (_e3) {
              if (0 < s) for (; l--;) {
                c[l] || f[l] || (f[l] = tt.call(r));
              }
              f = Lt(f);
            }

            rt.apply(r, f), o && !_e3 && 0 < f.length && 1 < s + v.length && Et.uniqueSort(r);
          }
  ...
  var It = Array.isArray,
    ...
    toArray: function toArray(e) {
      var t,
          n,
          r = e;
      if (!It(e)) for (r = [], t = 0, n = e.length; t < n; t++) {
        r[t] = e[t];
      }
      return r;
    },
    ...
    if (nn(t)) t = rn(t, bn(e[0]));else if (t.length && !t.nodeType) {
      if (t = Rn.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) {
        on(e, t[o], n, r);
  ...
  mn.fn = mn.prototype = {
    ...
    add: function add(e, t) {
      ...
      if (!1 !== t) for (n = Rn.unique(o.toArray().concat(Rn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++) {
        o[r] = n[r];
    ...
    prop: function prop(e, t) {
      var n = this;
      if ("object" == _typeof(e = cn[e] || e)) vn(e, function (e, t) {
        n.prop(e, t);
      });else {
  ...
  var Nn,
    ...
    getPos: function getPos(e, t, n) {
      ...
      if (n = n || e, t) {
        ...
        for (r = t; r && r !== n && r.nodeType && !ro(r, n);) {
          a += r.offsetLeft || 0, u += r.offsetTop || 0, r = r.offsetParent;
        }

        for (r = t.parentNode; r && r !== n && r.nodeType && !ro(r, n);) {
  ...
  kn = undefined, Tn = io, An = ao, Mn = undefined, function (e) {
    "object" == _typeof(Tn) && void 0 !== An ? An.exports = e() : "function" == typeof kn && kn.amd ? kn([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = e();
  }(function () {
    return function c(i, a, u) {
      ...
      for (var l = "function" == typeof Mn && Mn, e = 0; e < u.length; e++) {
        s(u[e]);
      }
  ...
  var ri = function ri(e, t) {
    ...
    if (e) {
      for (e = e.split(","), t = t || 10, n = 0; n < e.length; n += 2) {
        r = String.fromCharCode(parseInt(e[n], t)), Co[r] || (o = "&" + e[n + 1] + ";", i[r] = o, i[o] = r);
      }
  ...
  var oi = function oi(e, t) {
    ...
    var u,
      ...
      for (t = t || "", "string" == typeof (n = n || []) && (n = gi(n)), r = (e = gi(e)).length; r--;) {
        i = {
  ...
  function yi(i) {
    ...
    var E = function E(e) {
      ...
      var t,
          ...
          w = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
          x = /[*?+]/;
      if (e) for (e = gi(e, ","), z["@"] && (p = z["@"].attributes, v = z["@"].attributesOrder), t = 0, n = e.length; t < n; t++) {
        if (i = C.exec(e[t])) {
          ...
          if (s) for (r = 0, o = (s = gi(s, "|")).length; r < o; r++) {
            if (i = w.exec(s[r])) {
  ...
  var bi,
    ...
    for (b = b || {}, e && (l = e.getValidStyles(), c = e.getInvalidStyles()), t = ("\\\" \\' \\; \\: ; : " + S).split(" "), C = 0; C < t.length; C++) {
      E[t[C]] = S + C, E[S + C] = t[C];
    }
    ...
    return {
      ...
      serialize: function serialize(i, e) {
        var t,
            ...
            s = function s(e) {
          var t, n, r, o;
          if (t = l[e]) for (n = 0, r = t.length; n < r; n++) {
            e = t[n], (o = i[e]) && (u += (0 < u.length ? " " : "") + e + ": " + o + ";");
          }
        };

        if (e && l) s("*"), s(e);else for (t in i) {
          !(n = i[t]) || c && (r = t, o = e, a = void 0, (a = c["*"]) && a[r] || (a = c[o]) && a[r]) || (u += (0 < u.length ? " " : "") + t + ": " + n + ";");
        }
        return u;
      }
    };
    ...
    var r = {},
      ...
      var b = function b(e) {
        ...
        if (e = Xt._addCacheSuffix(e), y[e] ? a = y[e] : (a = {
          passed: [],
          failed: []
        }, y[e] = a), t && a.passed.push(t), _n2 && a.failed.push(_n2), 1 !== a.status) if (2 !== a.status) {
          if (3 !== a.status) {
        ...
        return ho.nu(function (e) {
          n(_t2, q(e, $(yo.value(_t2))), q(e, $(yo.error(_t2))));
        });
      },
          o = function o(e) {
        return e.fold(W, W);
      ...
      createHTML: function createHTML(e, t, n) {
        ...
        for (r in o += "<" + e, t) {
          t.hasOwnProperty(r) && null !== t[r] && "undefined" != typeof t[r] && (o += " " + r + '="' + _(t[r]) + '"');
        }
      ...
      loadCSS: function loadCSS(e) {
        ...
        F === Mi.DOM || a !== j.document ? (e || (e = ""), n = a.getElementsByTagName("head")[0], xi(e.split(","), function (e) {
          var t;
          e = Xt._addCacheSuffix(e), o[e] || (o[e] = !0, t = R("link", _G({
            rel: "stylesheet",
            type: "text/css",
            href: e
          }, u.contentCssCors ? {
      ...
      i.queueLoadedCallbacks.push({
        ...
        if (n.length = 0, Bi(e, function (e) {
          2 !== i.states[e] ? 3 !== i.states[e] ? 1 !== i.states[e] && (i.states[e] = 1, i.loading++, i.loadScript(e, function () {
            i.states[e] = 2, i.loading--, u("success", e), _o2();
          }, function () {
            i.states[e] = 3, i.loading--, a.push(e), u("failure", e), _o2();
  ...
  var la,
    ...
    if (gu(e.container())) if (e.isAtEnd()) n = Nu(e.container(), e.offset()), wu(n) && i(n, n.data.length), bu(n) && !xu(n) && o(Ru(Mu(n), !1));else {
  ...
  var Bu,
    ...
    for (Bo.isText(a) ? s.push(n ? function (e, t, n) {
      ...
      for (o = e(t.data.slice(0, n)).length, r = t.previousSibling; r && Bo.isText(r); r = r.previousSibling) {
        o += e(r.data).length;
      }

      return o;
    }(t, a, u) : u) : (u >= (i = a.childNodes).length && i.length && (l = 1, u = Math.max(0, i.length - 1)), s.push(e.nodeIndex(i[u], n) + l)); a && a !== c; a = a.parentNode) {
    ...
    var a,
        ...
        f,
        d,
        h = Zu((a = i).startContainer, a.startOffset) || Zu(a.endContainer, a.endOffset);
    return h ? {
      name: o = h.tagName,
      index: Gu(n.dom, o, h)
    ...
    var r,
        ...
        a,
        u,
        s = nu(t.getBoundingClientRect(), n);
    ...
    var t,
      ...
      !function (e) {
        ...
        for (t = Rn("*[contentEditable=false]", e), o = 0; o < t.length; o++) {
          r = (n = t[o]).previousSibling, Fa(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(i.length - 1, 1)), r = n.nextSibling, Ia(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(0, 1));
        }
  ...
  var Ws = Bo.isContentEditableFalse,
    ...
    moveStart: function moveStart(e, t, n) {
      var r,
          ...
          a = n.startOffset,
          u = n.startContainer;
      if ((n.startContainer !== n.endContainer || !Nl(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType) for (a < (i = u.childNodes).length ? (u = i[a], r = new Oo(u, e.getParent(u, e.isBlock))) : (u = i[i.length - 1], (r = new Oo(u, e.getParent(u, e.isBlock))).next(!0)), o = r.current(); o; o = r.next()) {
    ...
    if (o && e[0].wrapper && (o = Al(i, o, "ul,ol").reverse()[0] || o), !o) for (o = n; o[r] && !i.isBlock(o[r]) && (o = o[r], !kl.isEq(o, "br"));) {
      ;
    }
    return o || n;
  },
      Pl = function Pl(e, t, n, r, o, i, a) {
    var u, s, l, c, f, d;
  ...
  var Ul = function iE(n, r) {
    ...
    return {
      ...
      getAll: function getAll(e) {
        var t,
            ...
            o,
            i,
            a = (t = u, n = e, r = sr.fromDom(t.getBody()), o = ua(r, "[" + pa() + '="' + n + '"]'), i = {}, A(o, function (e) {
          var t = Ar(e, va()),
    ...
    return a.create = function (e, t) {
      ...
      for (var t = [], n = this.firstChild; n; n = Jl(n, this)) {
        n.name === e && t.push(n);
      }
      ...
      if (this.firstChild) {
        for (var e = [], t = this.firstChild; t; t = Jl(t, this)) {
          e.push(t);
        }
    ...
    return {
      parse: function parse(e) {
        ...
        for (E = new RegExp("<(?:(?:!--([\\w\\W]*?)--\x3e)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), S = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, s = I.getShortEndedElements(), N = V.self_closing_elements || I.getSelfClosingElements(), m = I.getBoolAttrs(), g = V.validate, u = V.remove_internals, A = V.fix_self_closing, k = I.getSpecialElements(), z = e + ">"; t = E.exec(z);) {
          if (M < t.index && j(_(e.substr(M, t.index - M))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), H(n);else if (n = t[7]) {
            ...
            if (!g || (c = I.getElementRule(n))) {
              if (f = !0, g && (y = c.attributes, b = c.attributePatterns), (v = t[8]) ? ((h = -1 !== v.indexOf("data-mce-type")) && u && (f = !1), (d = []).map = {}, v.replace(S, L)) : (d = []).map = {}, g && !h) {
                if (C = c.attributesRequired, w = c.attributesDefault, x = c.attributesForced, c.removeEmptyAttrs && !d.length && (f = !1), x) for (o = x.length; o--;) {
                  a = (p = x[o]).name, "{$uid}" === (T = p.value) && (T = "mce_" + D++), d.map[a] = T, d.push({
                    name: a,
                    value: T
                  });
                }
                if (w) for (o = w.length; o--;) {
                  (a = (p = w[o]).name) in d.map || ("{$uid}" === (T = p.value) && (T = "mce_" + D++), d.map[a] = T, d.push({
                    name: a,
                    value: T
                  }));
                }
        ...
        for (M < e.length && j(_(e.substr(M))), o = R.length - 1; 0 <= o; o--) {
          (n = R[o]).valid && $(n.name);
        }
      }
    };
  ...
  var nc,
    ...
    for (u = e.getTempAttrs(), s = c, l = new RegExp(["\\s?(" + u.join("|") + ')="[^"]+"'].join("|"), "gi"), c = s.replace(l, ""), a = d.getShortEndedElements(); i = f.exec(c);) {
      r = f.lastIndex, o = i[0].length, n = a[i[1]] ? r : rc.findEndTag(d, c, r), c = c.substring(0, r - o) + c.substring(n), f.lastIndex = r - o;
    }
    ...
    var r, o, i, a, u;
    if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Xt.trim(ic.trimExternal(e.serializer, n.innerHTML));else if ("text" === t.format) r = Ma(n.innerText || n.textContent);else {
          ...
          if (c) c(e);else {
            if (t = e.name, n = e.shortEnded, r = e.attributes, d && r && 1 < r.length && ((a = []).map = {}, l = m.getElementRule(e.name))) {
              for (u = 0, s = l.attributesOrder.length; u < s; u++) {
                (o = l.attributesOrder[u]) in r.map && (i = r.map[o], a.map[o] = i, a.push({
                  name: o,
                  value: i
                }));
              }
  ...
  function Cd(n) {
    var t,
      ...
      if (!n.removed && bd(n)) return R(o, function (e) {
        return t = i().getArgs(e), n = _r2, !(t.type !== n.type || t.text !== n.text || t.progressBar || t.timeout || n.progressBar || n.timeout);
        var t, n;
      }).getOrThunk(function () {
        n.editorManager.setActive(n);
        var e,
            t = i().open(_r2, function () {
          u(t), a();
        });
    ...
    return n = (u = e).inline ? ah(u.getBody()) : {
      ...
      pageX: (o = function (e, t) {
        ...
        var n,
            ...
            i,
            a,
            u = ah(e.getContentAreaContainer()),
  ...
  var vh,
    ...
    var r,
        ...
        s,
        l,
        c = ph(S(I(e.getElementsByTagName("*")), xs)),
        f = S(c, function (e) {
      return n >= e.top && n <= e.bottom;
    });
    return (r = Mh(f, t)) && (r = Mh((a = e, l = function l(t, e) {
      var n;
    ...
    return Ae.ceFalse && function () {
      ...
      r = !1, (n = m).on("touchstart", function () {
        ...
        var t,
            n = e.target;
        if ((n === a || "HTML" === n.nodeName || m.dom.isChildOf(n, a)) && !1 !== yd(m, e.clientX, e.clientY)) if (t = am(m, n)) im(t) ? (e.preventDefault(), l(Lh(m, t))) : (c(), om(t) && e.shiftKey || _h(e.clientX, e.clientY, m.selection.getRng()) || (C(), m.selection.placeCaretAt(e.clientX, e.clientY)));else if (!1 === xs(n)) {
          c(), C();
    ...
    var e = m.length + g.length + 2,
      ...
      for (p[1 + h] = e, v[1 + h] = t + 1, a = 0; a <= h; ++a) {
        for (u = -a; u <= a; u += 2) {
          for (s = u + h, u === -a || u !== a && p[s - 1] < p[s + 1] ? p[s] = p[s + 1] : p[s] = p[s - 1] + 1, c = (l = p[s]) - e + n - u; l < t && c < r && m[l] === g[c];) {
            p[s] = ++l, ++c;
          }
        ...
        for (u = f - a; u <= f + a; u += 2) {
          for (s = u + h - f, u === f - a || u !== f + a && v[s + 1] <= v[s - 1] ? v[s] = v[s + 1] - 1 : v[s] = v[s - 1], c = (l = v[s] - 1) - e + n - u; e <= l && n <= c && m[l] === g[c];) {
            v[s] = l--, c--;
          }
    ...
    var t = ua(e, "br"),
        n = S(function (e) {
      for (var t = [], n = e.dom(); n;) {
        t.push(sr.fromDom(n)), n = n.lastChild;
      }
    ...
    matchAll: function matchAll(r, o, i) {
      ...
      return e = r.selection.getStart(), r.dom.getParent(e, function (e) {
        ...
        for (t = 0; t < o.length; t++) {
          n = o[t], !u[n] && _m(r, e, n, i) && (u[n] = !0, a.push(n));
        }
      }, r.dom.getRoot()), a;
    },
    canApply: function canApply(e, t) {
      var n,
          ...
          u = e.formatter.get(t),
          s = e.dom;
      if (u) for (n = e.selection.getStart(), r = kl.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
    ...
    return function (e) {
      ...
      do {
        if (jm(t)) t = r.next(!0);else if (Um(t)) t = r.next();else if (Bo.isBr(t)) n++, t = r.next();else {
          if (Im(e, t)) return !1;
          t = r.next();
        }
      } while (t);
    ...
    return Tr(t, {
      ...
      ug = function ug(e, t, n) {
    void 0 === n && (n = !0);
    var r,
        o = e.dom,
        i = e.selection;
    if (og(t)) tg(e, !1, sr.fromDom(t), n);else {
      var a = i.getRng(),
    ...
    var r = e.dom,
        o = e.selection;
    if (t) ug(e, t, n);else if (!(t = as(e.getBody(), o.getStart()))) for (; t = r.get(rg);) {
      ug(e, t, !1);
    }
  },
  ...
  var vg = function vg(e, t) {
    ...
    this.compare = function (e, t) {
      ...
      var n = function n(_n3) {
        var r = {};
        return yg(o.getAttribs(_n3), function (e) {
          var t = e.nodeName.toLowerCase();
    ...
    var t,
      ...
      var n,
          ...
          i,
          a,
          u = (n = s, t = e, r = l, o = c, i = f, wg(kl.getParents(n.dom, t.parentNode).reverse(), function (e) {
        var t;
      ...
      return function (e, t, n, r, o, i, a, u) {
        ...
        m = function m(e) {
      var t, n, r, o, i;
      if (Bo.isElement(e) && u.getContentEditable(e) && (o = a, a = "true" === u.getContentEditable(e), i = !0), t = Xt.grep(e.childNodes), a && !i) for (n = 0, r = d.length; n < r && !Tg(s, d[n], c, e, e); n++) {
        ;
      }
    ...
    }(s, l, c, f) : (t = rs.getPersistentBookmark(s.selection, !0), o(r.getRng()), r.moveToBookmark(t), h.inline && Bm.match(s, l, c, r.getStart()) && kl.moveStart(u, r, r.getRng()), s.nodeChanged());else {
      e = r.getNode();
    ...
    if ("false" !== i.getContentEditable(n.getNode())) {
      if (y) {
        if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Vl(m, t, v), 0, !0)) : a(i, r, 0, !0);else if (o && y.inline && !i.select("td[data-mce-selected],th[data-mce-selected]").length) !function (e, t, n) {
          var r,
              o,
              i,
              a,
  ...
  var tp = Xt.each,
    ...
    var n,
      ...
      var r,
          ...
          f = 0 < e.length && e[0],
          d = f && f.name;
      if (u = d, s = "string" != typeof (a = n) ? a.nodeName.toLowerCase() : a, l = h.getElementRule(s), i = !(!(c = l && l.parentsRequired) || !c.length) && (u && -1 !== Xt.inArray(c, u) ? u : c[0])) d === i ? (o = e[0], e = e.slice(1)) : o = i;else if (f) o = e[0], e = e.slice(1);else if (!t) return n;
    ...
    t.addAttributeFilter("data-mce-tabindex", function (e, t) {
      ...
      for (var n, r, o = e.length, i = "data-mce-" + t, a = s.url_converter, u = s.url_converter_scope; o--;) {
        (r = (n = e[o]).attr(i)) !== undefined ? (n.attr(t, 0 < r.length ? r : null), n.attr(i, null)) : (r = n.attr(t), "style" === t ? r = l.serializeStyle(l.parseStyle(r), n.name) : a && (r = a.call(u, r, t, n.name)), n.attr(t, 0 < r.length ? r : null));
      }
      ...
      for (var r, o = e.length; o--;) {
        "bookmark" !== (r = e[o]).attr("data-mce-type") || n.cleanup || (T.from(r.firstChild).exists(function (e) {
          return !Ta(e.value);
        }) ? r.unwrap() : r.remove());
      }
    }), t.addNodeFilter("noscript", function (e) {
      for (var t, n = e.length; n--;) {
        (t = e[n].firstChild) && (t.value = ui.decode(t.value));
      }
      ...
      parse: function parse(e, u) {
        ...
        t = rc({
          ...
          start: function start(e, t, n) {
            ...
            if (i = v ? A.getElementRule(e) : {}) {
              for ((r = E(i.outputName || e, 1)).attributes = t, r.shortEnded = n, d.append(r), (u = p[d.name]) && p[r.name] && !u[r.name] && h.push(r), o = R.length; o--;) {
        ...
        if (t.parse(e), v && h.length && (u.context ? u.invalid = !0 : function (e) {
            ...
            if ((n = e[t]).parent && !n.fixed) if (h[n.name] && "li" === n.parent.name) {
              ...
              if (r && 1 < o.length) {
                for (o.reverse(), i = a = B(o[0].clone()), l = 0; l < o.length - 1; l++) {
                  for (A.isValidChild(a.name, o[l].name) ? (u = B(o[l].clone()), a.append(u)) : u = a, s = o[l].firstChild; s && s !== o[l + 1];) {
          ...
          if (A.isValidChild(k.name, b.toLowerCase())) {
            for (; n;) {
              e = n.next, 3 === n.type || 1 === n.type && "p" !== n.name && !c[n.name] && !n.attr("data-mce-type") ? (t || ((t = E(b, 1)).attr(T.forced_root_block_attrs), k.insert(t, n)), t.append(n)) : (r(t), t = null), n = e;
            }
    ...
    return p = (e = t).schema, (g = T).remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
      ...
      for (var t, n, r, o, i, a, u, s = e.length, l = p.getValidClasses(); s--;) {
        for (n = (t = e[s]).attr("class").split(" "), i = "", r = 0; r < n.length; r++) {
          o = n[r], u = !1, (a = l["*"]) && a[o] && (u = !0), a = l[t.name], !u && a && a[o] && (u = !0), u && (i && (i += " "), i += o);
        }
    ...
    -1 === Xt.inArray(t, n) && (e.addAttributeFilter(n, function (e, t) {
      ...
      Ep = function Ep(e, t, n, r, o) {
    var i,
        a,
        u,
        s,
        l = (i = r, jc(t, n).serialize(i));
  ...
  var Ap = Tp,
    ...
    var M = function M(e) {
      ...
      var t,
          n,
          r = _e7.target;
      t = _e7, n = a.selection.getRng(), !M(t.target) || _h(t.clientX, t.clientY, n) || _e7.isDefaultPrevented() || a.selection.select(r);
    },
        R = function R(e) {
      ...
      var e = function e(_e8, t) {
        t && (u.style[_e8] || !a.schema.isValid(u.nodeName.toLowerCase(), _e8) ? z.setStyle(R(u), _e8, t) : z.setAttrib(R(u), _e8, t));
      };
      ...
      for (e in L(), u && u.removeAttribute("data-mce-selected"), c) {
  ...
  Object.freeze({
    ...
    var n,
        ...
        c,
        f,
        d = (r = (n = e).dom().ownerDocument, o = r.body, i = r.defaultView, a = r.documentElement, u = Hp(i.pageYOffset, a.scrollTop), s = Hp(i.pageXOffset, a.scrollLeft), l = Hp(a.clientTop, o.clientTop), c = Hp(a.clientLeft, o.clientLeft), Lp(n).translate(s - c, u - l)),
        h = (f = e, _p.get(f));
    return {
      element: e,
      bottom: d.top() + h,
    ...
    return Wp(sr.fromDom(e), i);
      ...
      Yp = function Yp(n, r, o, i) {
    Qp(n, function (e, t) {
      return Gp(n, r, o, i);
    }, o);
  },
      Gp = function Gp(e, t, n, r) {
    ...
    return R(n, function (e) {
      ...
      _v = function _v(e, t) {
    var n,
        r = sr.fromDom(t.commonAncestorContainer),
        o = Xd(r, e),
        i = S(o, function (e) {
      return Vo(e) || Lo(e);
    }),
    ...
    var n,
        ...
        s,
        l,
        c = (r = t, i = (n = e).selection.getRng(), a = n.dom.create("body"), u = n.selection.getSel(), s = fv(n, Nv(u)), (o = r.contextual ? Lv(sr.fromDom(n.getBody()), s).dom() : i.cloneContents()) && a.appendChild(o), n.selection.serializer.serialize(a, r));
  ...
  var Zv,
      ...
      getSelectedBlocks: function getSelectedBlocks(e, t) {
        return function (e, t, n, r) {
          var o,
              i,
              a = [];
          if (i = e.getRoot(), n = e.getParent(n || Yv(i, t, t.collapsed), e.isBlock), r = e.getParent(r || Gv(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new Oo(o = n, i); (o = u.next()) && o !== r;) {
    ...
    findRootInline: function findRootInline(e, t, n) {
      var r,
          o,
          i,
          a = (r = e, o = t, i = n, S(Di.DOM.getParents(i.container(), "*", o), r));
  ...
  var Xy,
    ...
    return function () {
      var e,
          ...
          u,
          s,
          l = (t = f, r = nl((e = c).getBody()), o = C(qs, r.next), i = C(qs, r.prev), a = t ? Bu.Forwards : Bu.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = sb(a, e, u, s)) ? n : (n = cb(e, a, s)) || null);
    ...
    return function () {
      var e,
          ...
          o,
          i,
          a = (r = (t = s) ? 1 : -1, o = t ? xh : wh, i = (e = u).selection.getRng(), (n = lb(r, e, o, i)) ? n : (n = cb(e, r, i)) || null);
    ...
    return function () {
      var t,
          e = o ? Hu.fromRangeEnd(r.selection.getRng()) : Hu.fromRangeStart(r.selection.getRng()),
      ...
      mb = function mb(e, t, n, r, o) {
    var i,
        a,
        u,
        s,
        l = ua(sr.fromDom(n), "td,th,caption").map(function (e) {
      return e.dom();
    }),
        c = S((i = e, O(l, function (e) {
      var t,
          n,
          r = (t = tu(e.getBoundingClientRect()), n = -1, {
        left: t.left - n,
        top: t.top - n,
        right: t.right + 2 * n,
        bottom: t.bottom + 2 * n,
    ...
    return fu([t, n], qb).filter(function (e) {
      ...
      Kb = function Kb(e, t, n) {
    return n.collapsed ? Wb(e, t, n) : T.none();
  },
      Xb = function Xb(e) {
    var t,
        n = (t = Jr(e), D(t, Po).fold(function () {
      return t;
    }, function (e) {
      return t.slice(0, e);
    }));
    ...
    return Zb(!0, t), Zb(!1, n), Qb(t, n).fold(C(Jb, e, t, n), C(Gb, e, t, n));
      ...
      tC = function tC(e, t, n, r) {
    return t ? eC(e, r, n) : eC(e, n, r);
  },
      nC = function nC(t, n) {
    var e,
        r = sr.fromDom(t.getBody());
    ...
    var n,
        r,
        o = hl.prevPosition(e.dom(), Hu.fromRangeStart(t)).isNone(),
    ...
    return Ib(sr.fromDom(e), sr.fromDom(n.getNode())).map(function (e) {
      ...
      gC = function gC(u, s, l) {
    return hl.fromPosition(s, u, l).bind(function (e) {
      return a = e.getNode(), Wo(sr.fromDom(a)) || jo(sr.fromDom(a)) ? T.none() : (t = u, o = e, i = function i(e) {
    ...
    return e.selection.isCollapsed() ? yC(e, t) : bC(e, t);
      ...
      xC = function xC(e) {
    var t,
        n = CC(e.getBody(), e.selection.getNode());
    return Bo.isContentEditableTrue(n) && e.dom.isBlock(n) && e.dom.isEmpty(n) && (t = e.dom.create("br", {
      ...
      zC = function zC(e, t, n, r, o, i) {
    var a,
        u,
        s = Hh(r, e, i.getNode(!o), o, !0);
    ...
    r.undoManager.ignore(function () {
      ...
      kC = function kC(n, r, i, o) {
    var e,
        t,
        a = (e = n.getBody(), t = o.container(), _s(t, e) || e),
    ...
    var n,
        ...
        i,
        a,
        u = sr.fromDom(e.selection.getStart(!0)),
        s = Rv(e);
    ...
    if (n !== e.getBody()) {
      ...
      var s,
          l,
          c = o ? t(o) : i.create("BR");
      if (Mw(n, r, !0) && Mw(n, r, !1)) kw(n, "LI") ? i.insertAfter(c, Aw(n)) : i.replace(c, n);else if (Mw(n, r, !0)) kw(n, "LI") ? (i.insertAfter(c, Aw(n)), c.appendChild(i.doc.createTextNode(" ")), c.appendChild(n)) : n.parentNode.insertBefore(c, n);else if (Mw(n, r, !1)) i.insertAfter(c, Aw(n));else {
        n = Aw(n);
        var f = a.cloneRange();
    ...
    var t,
      ...
      if (e || "TABLE" === f || "HR" === f ? (t = g.create(e || h), Lw(a, t)) : t = l.cloneNode(!1), r = t, !1 === yc(a)) g.setAttrib(t, "style", null), g.setAttrib(t, "class", null);else do {
        if (i[o.nodeName]) {
    ...
    Bo.isElement(s) && s.hasChildNodes() && (m = i > s.childNodes.length - 1, s = s.childNodes[Math.min(i, s.childNodes.length - 1)] || s, i = m && Bo.isText(s) ? s.nodeValue.length : 0), (u = Hw(g, s)) && ((h && !n || !h && n) && (s = function (e, t, n, r, o) {
      ...
      if (!(a = h.getParent(r, h.isBlock)) || !Bw(h, a)) {
        ...
        if (u && e.schema.isValidChild(c, d.toLowerCase())) {
          for (i = h.create(d), Lw(e, i), u.parentNode.insertBefore(i, u), s = u; s && !h.isBlock(s);) {
    ...
    var n,
        r,
        o,
        i = (n = e, r = C(py.isInlineTarget, n), o = Hu.fromRangeStart(n.selection.getRng()), Oy(r, n.getBody(), o).filter(Ww));
    ...
    var n,
        r,
        o,
        i = (r = (n = t).container(), o = n.offset(), Bo.isText(r) && o < r.data.length ? _u(r, o + 1) : n);
    ...
    t.hasAttribute("data-mce-caret") && (Ua(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
      ...
      Dx = function Dx(e, t) {
    var n,
        r = (n = e, ha(sr.fromDom(n.getBody()), "*[data-mce-caret]").fold($(null), function (e) {
      return e.dom();
    }));
    ...
    i.inline || (t.getElement().style.visibility = t.orgVisibility), e || t.inline || (s.open(), s.write(t.iframeHTML), s.close()), t.inline && (t.on("remove", function () {
      ...
      for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--;) {
        (t = e[n]).isEmpty(r) && 0 === t.getAll("br").length && (t.append(new Ql("br", 1)).shortEnded = !0);
      }
    ...
    return e.inline ? Qx(null) : (t = r, n = Yx.create("div"), Yx.insertAfter(n, t), Qx(n));
      ...
      ez = function ez(e) {
    var n, t, r, o, i, a;
    e.fire("ScriptsLoaded"), n = e, t = Xt.trim(n.settings.icons), r = n.ui.registry.getAll().icons, o = _G({}, {
    ...
    var u,
        ...
        c,
        f,
        d = (f = (u = e).getElement(), u.orgDisplay = f.style.display, K(u.settings.theme) ? u.theme.renderUI() : y(u.settings.theme) ? (l = (s = u).getElement(), (c = (0, s.settings.theme)(s, l)).editorContainer.nodeType && (c.editorContainer.id = c.editorContainer.id || s.id + "_parent"), c.iframeContainer && c.iframeContainer.nodeType && (c.iframeContainer.id = c.iframeContainer.id || s.id + "_iframecontainer"), c.height = c.iframeHeight ? c.iframeHeight : l.offsetHeight, c) : Zx(u));
    ...
    !function (e, t, n, r) {
      ...
      !function (e, t) {
        ...
        if ((e = Xt.trim(e)) && !Md.urls[e]) if (nz(e)) {
    ...
    if (/^ | $/.test(t) && (t = function (e, t) {
      ...
      }(u), "mce_marker" === (f = u.lastChild).attr("id")) for (f = (l = f).prev; f; f = f.walk(!0)) {
      ...
      if (e._selectionOverrides.showBlockCaretContainer(i), k.invalid) {
        for (Sz(e, d), i = m.getNode(), a = e.getBody(), 9 === i.nodeType ? i = f = a : f = i; f !== a;) {
          f = (i = f).parentNode;
        }
    ...
    return e.isNative = function (e) {
      ...
      if (!1 === t && (t = l), t) {
        ...
        for (r && Xt.extend(u, r), a = (i = e.toLowerCase().split(" ")).length; a--;) {
    ...
    unbindAllNativeEvents: function unbindAllNativeEvents() {
      ...
      if (t.delegates) {
        for (e in t.delegates) {
          t.dom.unbind(Kz(t, e), e, t.delegates[e]);
        }
    ...
    init: function init(r) {
      ...
      var l = function l(e) {
        ...
        mN.unbind(window, "ready", e), function (e) {
          var t = r[e];
  ...
  UN.extend = _MN = function MN(n) {
    var e,
        ...
        i = function i() {
      var e, t, n;
      if (!RN && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) {
    ...
    for (t in RN = !0, e = new this(), RN = !1, n.Mixins && (IN(n.Mixins, function (e) {
      ...
      i[t] = e;
    }), n.Defaults && o.Defaults && (n.Defaults = FN({}, o.Defaults, n.Defaults)), n) {
      "function" == typeof (r = n[t]) && o[t] ? e[t] = u(t, r) : e[t] = r;
    }

    return i.prototype = e, (i.constructor = i).extend = _MN, i;
  };
  ...
  var tE,
    ...
    util: {
      ...
      Color: function Color(e) {
        var n = {},
            ...
            t = function t(e) {
          var t;
          return "object" == _typeof(e) ? "r" in e ? (u = e.r, s = e.g, l = e.b) : "v" in e && function (e, t, n) {
            var r, o, i, a;
        ...
        return e && t(e), n.toRgb = function () {
          ...
          var e = function e(_e10) {
            return 1 < (_e10 = parseInt(_e10, 10).toString(16)).length ? _e10 : "0" + _e10;
          };
    ...
    isMac: Ae.mac
      ...
      rE = Xt.extend(SN, nE);
  tE = rE, window.tinymce = tE, window.tinyMCE = tE, function (e) {
...
!function () {
  ...
  for (var n, e, o, w, i, t = function t(n) {
    return function () {
      return n;
    };
  }, d = t(!1), r = t(!0), a = d, l = r, s = function s() {
    return u;
  }, u = (w = {
    ...
    toString: t("none()")
  }, Object.freeze && Object.freeze(w), w), c = function c(o) {
    var n = function n() {
      return o;
    },
        e = function e() {
    ...
    h[C] = (C + 256).toString(16).substr(1);
  }
  ...
  var V = function V() {
    var n,
        ...
        o,
        w = function () {
      for (var n = new Array(16), e = 0, o = 0; o < 16; o++) {
        0 == (3 & o) && (e = 4294967296 * Math.random()), n[o] = e >>> ((3 & o) << 3) & 255;
      }
    ...
    var t,
      ...
      send: function send(n, e) {
        var o,
          ...
          var o,
              w = i[e];
          return "string" == (o = _typeof(w)) || "number" === o ? w.toString() : n;
        }));
  ...
  !function () {
    ...
    var a = function a() {},
      ...
      return a === b;
        ...
        g = function g(a) {
      for (var b = new Array(arguments.length - 1), c = 1; c < arguments.length; c++) {
        b[c - 1] = arguments[c];
      }
    ...
    return function () {
      var a = function a(_a3, b) {
        aa.getApiKey(_a3.settings).bind(function (b) {
          return aa.getServiceUrl(_a3.settings).map(function (a) {
...
module.exports = __webpack_require__(/*! /home/ec2-user/environment/mydiary/resources/js/tinymce.min.js */"./resources/js/tinymce.min.js");
