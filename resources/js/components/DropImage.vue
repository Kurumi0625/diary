<template>
      <div class="file-area">
          ...
          <div>
              ...
              <a v-if="imgData" v-on:click="onDelete(image_id)" class="btn btn-danger delete-btn">削除する</a>
          </div>
          <div v-if="msg">
              <span class="text-danger">{{msg}}</span>
          </div>
          <div v-for="(deletedId) in deletedIds">
              <input type="hidden" name="deletedIds[]" :value="deletedId">
          </div>
      </div>
  </template>
